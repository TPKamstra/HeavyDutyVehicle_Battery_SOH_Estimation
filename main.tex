...
% Zotero library, resolved against the live-synced zoreto-library.bib
...
%   zoreto-library.bib  -- live-synced from your Zotero library via
%                          Overleaf's Zotero integration. NOTE: the
%                          file is actually named "zoreto-library.bib"
...
\bibliography{references,zoreto-library}
